									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Kembali</button>
												<a href="<?= base_url() ?>user/addCollections/<?= $db->book_id ?>" class="btn btn-info" onclick="return confirm('Are you sure to add this book to your collections?')"><i data-feather="heart"></i></a>
        									<a href="<?= base_url() ?>user/loansBook/<?= $db->book_id ?>/<?= $this->session->userdata('users_id') ?>" class="btn btn-primary" onclick="return confirm('Are you sure to loans this book?')" >Pinjam Buku</a>
										</div>
									</div>
								</div>
							</div>
